  ...
  dashboard: {
    ...
    widgets: {
      ...
      quickSign: {
        title: 'Quick Sign',
        caption:
          'Compose a structured event, choose your signing account, review selected-account relay destinations from kind 10002 metadata, then preview before signing and publishing.',
