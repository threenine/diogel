...
export default {
  ...
  dashboard: {
    ...
    widgets: {
      ...
      quickSign: {
        title: 'Quick Sign',
        caption: 'Create a kind 1 text note, preview it, then sign with your active account.',
        ready: 'Fill out the form, preview the event, and confirm signing.',
        kind: 'Event Kind',
        kindTextNote: 'Text Note (kind 1)',
        content: 'Content',
        publish: 'Publish to online relays after signing',
