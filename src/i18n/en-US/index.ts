...
export default {
  ...
  dashboard: {
    ...
    widgets: {
      ...
      quickSign: {
        title: 'Quick Sign',
        caption: 'Paste or edit event JSON, choose account and relay targets, then preview before signing.',
        ...
        states: {
          ...
          noRelay: 'No online relays are available. Connect at least one relay to publish.',
