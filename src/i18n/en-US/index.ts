...
export default {
  ...
  dashboard: {
    ...
    widgets: {
      ...
      quickSign: {
        title: 'Quick Sign',
        caption: 'Paste or edit event JSON, choose account and explicit relay targets from that account’s kind 10002 metadata, then preview before signing.',
        ready: 'Provide event JSON, review the normalized event, and confirm signing.',
        account: 'Signing Account',
        eventJson: 'Event JSON',
        supportedKinds: 'Supported kinds: 0, 1, 3, 7, 30023',
        publish: 'Publish after signing',
        publishDestinationSummary: 'Will publish to {count} selected account relay | Will publish to {count} selected account relays',
        relays: 'Publish Relays',
        preview: 'Preview Event',
        previewTitle: 'Confirm Event Before Signing',
        previewAccount: 'Account:',
        previewRelays: 'Publish destination:',
        cancel: 'Cancel',
        confirm: 'Sign Event',
        signSuccess: 'Event signed successfully.',
