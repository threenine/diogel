export enum Kind {
  ...
  FollowSet = 30000,
  CategorizedPeopleList = Kind.FollowSet, // Deprecated but left for backwards compatibility
  CategorizedBookmarkList = 30001, // Deprecated but left for backwards compatibility
  RelaySet = 30002,
  CategorizedRelayList = Kind.RelaySet, // Deprecated but left for backwards compatibility
  BookmarkSet = 30003,
  ...
  InterestSet = 30015,
  InterestsList = Kind.InterestSet, // Deprecated but left for backwards compatibility
  ...
  HighlightSet = 39802,
  CategorizedHighlightList = Kind.HighlightSet, // Deprecated but left for backwards compatibility
...
export const ListKinds = [
  ...
  Kind.PublicChatList,
  Kind.BlockRelayList,
  Kind.SearchRelayList,
  Kind.RelayFeedList,
  Kind.InterestList,
  Kind.EmojiList,
  Kind.DirectMessageReceiveRelayList,
  Kind.FollowSet,
  Kind.BookmarkSet,
  Kind.CategorizedBookmarkList, // Backwards compatibility
  Kind.RelaySet,
